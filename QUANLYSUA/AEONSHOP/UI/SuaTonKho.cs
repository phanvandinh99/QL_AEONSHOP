...
{
    public partial class SuaTonKho : Form
    {
        public SuaTonKho()
        {
            InitializeComponent();
        ...
        private void SuaTonKho_Load(object sender, EventArgs e)
        {
            ...
            if ("ALL".Equals(sMaLoaiSanPham))
            {
                ...
                var lst_Producr = db.SanPham.Join(db.ChiTietSanPham,
                                                  ...
                                                  (n, m) => new
                                                  {
                                                      ...
                                                      n.DaBan,
                                                      n.Anh
                                                  }).Where(n => n.NgaySuDungConLai > 0 & n.DaBan == 0);
            ...
            else
            {
                var lst_Producr = db.SanPham.Join(db.ChiTietSanPham,
                                  ...
                                  (n, m) => new
                                  {
                                      ...
                                      n.DaBan,
                                      n.Anh
                                  }).Where(n => n.MaLoaiSanPham == sMaLoaiSanPham & n.NgaySuDungConLai > 0 & n.DaBan == 0);
