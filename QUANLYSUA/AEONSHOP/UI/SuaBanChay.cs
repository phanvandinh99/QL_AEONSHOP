...
{
    public partial class SuaBanChay : Form
    {
        public SuaBanChay()
        {
            InitializeComponent();
        ...
        private void SuaBanChay_Load(object sender, EventArgs e)
        {
            ...
            if ("ALL".Equals(sMaLoaiSanPham))
            {
                ...
                var lst_Producr = db.SanPham.Join(db.ChiTietSanPham,
                                                  ...
                                                  (n, m) => new
                                                  {
                                                      ...
                                                      n.DaBan,
                                                      n.Anh
                                                  }).Where(n => n.NgaySuDungConLai <= 0).OrderByDescending(n=>n.DaBan).Take(9);
            ...
            else
            {
                var lst_Producr = db.SanPham.Join(db.ChiTietSanPham,
                                  ...
                                  (n, m) => new
                                  {
                                      ...
                                      n.DaBan,
                                      n.Anh
                                  }).Where(n => n.MaLoaiSanPham == sMaLoaiSanPham & n.NgaySuDungConLai <= 0).OrderByDescending(n => n.DaBan).Take(9);
